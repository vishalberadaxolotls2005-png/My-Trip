...
import 'package:my_trip/screens/homeScreen/discover_item/electrictiy/electricity_biller_bottom_sheet.dart';
import 'package:my_trip/screens/homeScreen/discover_item/water/water_biller_bottom_sheet.dart';

class ElectricityBillerDetails extends StatelessWidget {
              ...
              InkWell(
                onTap: (){
                  showModalBottomSheet(
                    ...
                    builder: (context) =>  ElectricityBillerBottomSheet(),
                  );
                },
                child: Container(
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    const Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'MSEDCL maharashtra state electricity board',
                            maxLines: 1,
                ...
                const SizedBox(height: 5),
                _buildDetailRow('Early Payment Date', '11-Jun-2026',),
                const SizedBox(height: 5),
                _buildDetailRow('Pc', '5'),
                const SizedBox(height: 5),
                _buildDetailRow('Disconn Tag','0'),
                const SizedBox(height: 5),
                _buildDetailRow('Bill Month','2606'),
                const SizedBox(height: 5),
                _buildDetailRow('DTC Code','96587459'),
                const SizedBox(height: 5),
                _buildDetailRow('Bill Type','Post Paid'),
