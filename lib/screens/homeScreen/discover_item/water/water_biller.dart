...
import 'package:my_trip/screens/homeScreen/discover_item/water/water_biller_details.dart';

class WaterBillerScreen extends StatefulWidget {
  const WaterBillerScreen({super.key});

  @override
  State<WaterBillerScreen> createState() => _WaterBillerScreenState();
}
...
class _WaterBillerScreenState extends State<WaterBillerScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: (){
Navigator.push(context, MaterialPageRoute(builder: (context)=>WaterBillDetailsScreen()));
                      },
                      child: Container(
  ...
  Widget _buildSelectBillerCard() {
    return _InputStyleCard(
      label: 'Select Biller',
      value: 'Maharashtra Jeevan Pradhikaran 105Vrr...',
    );
  }
