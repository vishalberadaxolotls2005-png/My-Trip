...
class WaterBillerBottomSheet extends StatefulWidget {

  @override
  State<WaterBillerBottomSheet> createState() =>
      _WaterBillerBottomSheetState();
}

class _WaterBillerBottomSheetState
    extends State<WaterBillerBottomSheet> {
