...
class ProccedToPaymentBottomSheet extends StatefulWidget {

  @override
  State<ProccedToPaymentBottomSheet> createState() =>
      _ProccedToPaymentBottomSheetState();
}

class _ProccedToPaymentBottomSheetState
    extends State<ProccedToPaymentBottomSheet> {
          ...
          Row(
            children: [
              ...
              Container(
                ...
                height: 44,
                decoration: const BoxDecoration(
                  color: Color(0xffC4C4C4), // Jio dark blue
                  shape: BoxShape.circle,
                ),

                child: ClipRRect(
                    borderRadius: BorderRadius.circular(50),
                    child: Image.asset("assets/images/indigo.png",fit: BoxFit.cover,)),
              ),
