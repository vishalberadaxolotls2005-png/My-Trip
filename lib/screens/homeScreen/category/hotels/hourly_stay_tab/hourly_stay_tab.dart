...
class HourlyStayTab extends StatefulWidget {
  ...
  @override
  State<HourlyStayTab> createState() => _HourlyStayTabState();
}

class _HourlyStayTabState extends State<HourlyStayTab> {
        ...
        child: Column(
          ...
          children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Center(child: Icon(Icons.search, color: HourlyStayTab.blackText, size: 20)),
                        ),
                        SizedBox(width: 10),
                        Expanded(
                          child: Column(
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                                child: Text("04:00PM", style: GoogleFonts.poppins(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w600,
                                  color: HourlyStayTab.blackText,
                                ),)
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                const SizedBox(width: 10),
                                Expanded(
                                    child: Text("1 Room, 2 Adults...", style: GoogleFonts.poppins(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600,
                                      color: HourlyStayTab.blackText,
                                    ),)
            ...
            Container(
              ...
              color: HourlyStayTab.screenBg,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Offers',
                      style: GoogleFonts.poppins(
                          fontSize: 18, fontWeight: FontWeight.w700, color: HourlyStayTab.blackText)),
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Text(offer.badgeLabel,
                    style: GoogleFonts.poppins(fontSize: 9, fontWeight: FontWeight.w700, color: HourlyStayTab.blackText)),
              ),
            ),
            Positioned(
              ...
              child: Container(
                ...
                child: Text(offer.brandLabel,
                    style: GoogleFonts.poppins(fontSize: 7, fontWeight: FontWeight.w700, color: HourlyStayTab.purple)),
              ),
            ),
            Positioned(
              left: 10,
