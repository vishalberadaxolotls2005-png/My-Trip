...
class HotelBookingBottomSheet extends StatefulWidget {
  ...
  @override
  State<HotelBookingBottomSheet> createState() =>
      _HotelBookingBottomSheetState();
}

class _HotelBookingBottomSheetState
    extends State<HotelBookingBottomSheet> {
            ...
            children: [
              ...
              Container(
                ...
                child: ClipRRect(
                    ...
                    child: Image.asset("assets/images/image 16.png",fit: BoxFit.cover,)),
              ),
