...
class WalletTransferBottomSheet extends StatefulWidget {

  @override
  State<WalletTransferBottomSheet> createState() =>
      _WalletTransferBottomSheetState();
}

class _WalletTransferBottomSheetState extends State<WalletTransferBottomSheet> {
