...
class WalletAddBottomSheet extends StatefulWidget {

  @override
  State<WalletAddBottomSheet> createState() =>
      _WalletAddBottomSheetState();
}

class _WalletAddBottomSheetState extends State<WalletAddBottomSheet> {
