    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                Text(trip.tripDateRange,
                    style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w500, color: const Color(0xff707070))),
              ],
            ),
          ),
          _DashedDivider(),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(trip.route,
                          style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: const Color(0xFF1B1B1B))),
          ...
          InkWell(
            onTap: () => onViewDetails(trip), // <-- passes THIS trip, not a generic callback
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  colors: [Color(0xff7750D5), Color(0xffB457EB), Color(0xffA751D8)],
                ),
              ),
              child: Center(
                child: Text(trip.buttonLabel,
